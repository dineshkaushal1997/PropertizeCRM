...
class AddRentCategory extends StatefulWidget {
  const AddRentCategory({Key? key}) : super(key: key);

  @override
  State<AddRentCategory> createState() => _AddRentCategoryState();
}

class _AddRentCategoryState extends State<AddRentCategory> {
