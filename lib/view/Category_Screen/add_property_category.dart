...
class AddPropertyManagement extends StatefulWidget {
  const AddPropertyManagement({Key? key}) : super(key: key);

  @override
  State<AddPropertyManagement> createState() => _AddPropertyManagementState();
}

class _AddPropertyManagementState extends State<AddPropertyManagement> {
